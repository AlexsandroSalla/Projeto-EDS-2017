...
<head>
  <meta charset="UTF-8">
  <title>Bem vindo Administrador <?= $nome.' '.$sobrenome ?></title>
...
<body>
  <div class="form">
          ...
          <p><?= $email ?></p>
		            ...
		            <a href="painelADM.php"><button class="button button-block" name="index"/>Painel ADM</button></a>
		  
		  
          <a href="logout.php"><button class="button button-block" name="logout"/>Sair</button></a>
    
	<script type="text/javascript">
   window.setTimeout("location.href='painelADM.php';", 5000);
	</script>
